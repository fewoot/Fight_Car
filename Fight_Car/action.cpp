...
bool goFront(int speed, Action_Direction direction, int turn_speed, int accel) {
	/*roboclaw.SetM1DefaultAccel(address, accel);
	roboclaw.SetM2DefaultAccel(address, accel);
	roboclaw.ForwardM1(address, speed-(direction * turn_speed));
	roboclaw.ForwardM2(address, speed+(direction * turn_speed));*/
	roboclaw.SpeedAccelM1(address, accel, speed - (direction * turn_speed));
	roboclaw.SpeedAccelM2(address, accel, speed + (direction * turn_speed));
	return true;
}
bool goFront(int speed) {
	roboclaw.SpeedAccelM1(address, 655360, speed);
	roboclaw.SpeedAccelM2(address, 655360, speed);
	return true;
}
bool goFront(int speed, Action_Direction direction, int turn_speed) {
	roboclaw.SpeedAccelM1(address, 655360, speed - (direction * turn_speed));
	roboclaw.SpeedAccelM2(address, 655360, speed + (direction * turn_speed));
	return true;
}
bool goFront() {
	roboclaw.SpeedAccelM1(address, 655360, 200);
	roboclaw.SpeedAccelM2(address, 655360, 200);
	return true;
}
//////////////////////////////////////////////////////////////////
...
bool turn(int speed, Action_Direction direction, int accel) {
	roboclaw.SpeedAccelM1(address, accel, -direction * speed  );
	roboclaw.SpeedAccelM2(address, accel, direction * speed  );
	return true;
}
bool turn(int speed, Action_Direction direction) {
	roboclaw.SpeedAccelM1(address, 655360, -direction * speed);
	roboclaw.SpeedAccelM2(address, 655360, direction * speed);
	return true;
}

////////////////////////////////////////////////////////////////////////
bool turnPosition(int speed, Action_Direction direction, int accel, int position) {
	roboclaw.SpeedAccelM1(address, accel, -(speed * direction));
	roboclaw.SpeedAccelM2(address, accel, (speed * direction));
	delay(position*1);
...
bool turnPosition(int speed, Action_Direction direction, int position) {
	roboclaw.SpeedAccelM1(address, 655360, -(speed * direction));
	roboclaw.SpeedAccelM2(address, 655360, (speed * direction));
	delay(position * 1);
	roboclaw.ForwardM1(address, 0);
	roboclaw.ForwardM2(address, 0);
	return true;
...
bool turnPosition(Action_Direction direction, int position) {
	roboclaw.SpeedAccelM1(address, 655360, -(800 * direction));
	roboclaw.SpeedAccelM2(address, 655360, (800 * direction));
	delay(position * 1);
	roboclaw.ForwardM1(address, 0);
	roboclaw.ForwardM2(address, 0);
	return true;
